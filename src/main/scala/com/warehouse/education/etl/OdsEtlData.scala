...
//flink run -m yarn-cluster -ynm odsetldata -p 12 -ys 4  -yjm 1024 -ytm 2048m -d -c com.atguigu.education.etl.OdsEtlData -yqu flink ./education-flink-online-1.0-SNAPSHOT-jar-with-dependencies.jar --group.id test --bootstrap.servers cdh02:9092,cdh03:9092,cdh04:9092 --topic basewebsite,basead,member,memberpaymoney,memberregtype,membervip
